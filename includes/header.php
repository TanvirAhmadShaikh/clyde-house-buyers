<header class="site-header">
  <div class="site-header-inner">
    <a href="/" class="site-logo" aria-label="Clyde Housebuyers — home">
      <img src="/assets/img/logo.png" alt="Clyde Housebuyers" width="166" height="52">
    </a>
    ...
    <nav class="site-nav" aria-label="Main">
      <div class="has-dropdown">
        ...
        <div class="dropdown" role="menu">
          <a href="/sellers/" class="dropdown-all">All areas we cover →</a>
      ...
      <div class="has-dropdown">
        ...
        <div class="dropdown" role="menu">
          <a href="/solutions/" class="dropdown-all">All solutions →</a>
      ...
      <div class="has-dropdown">
        ...
        <div class="dropdown" role="menu">
          <a href="/situations/" class="dropdown-all">All situations →</a>
    ...
    <div class="header-cta">
      <a href="tel:01415301430" class="header-phone" aria-label="Call us on 0141 530 1430">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
        0141 530 1430
      </a>
      <a href="/free-valuation.php" class="btn btn-primary header-btn">Free valuation</a>
...
<div class="mobile-nav" id="mobile-nav">
    ...
    <a href="tel:01415301430">📞 0141 530 1430</a>
    <a href="/free-valuation.php" class="btn btn-primary">Free valuation</a>
</div>
